...
BUCKETS = [
    # ETH-scale: BTC's ~$50-$500 displacement at ~$77K spot scales to ~$1-$13 at ETH ~$2K
    # Use ETH bands $1-$5 and $5-$20 to mirror K6 BTC band ratios.
    (0,   300,    1,    5,   'yes', 'A1',  5.1),
    (0,   300,    5,    20,  'yes', 'A2',  2.8),
    (0,   300,   -5,   -1,   'no',  'A1n', 0.3),
    (0,   300,  -20,   -5,   'no',  'A2n', 1.5),
    (300, 900,    1,    5,   'yes', 'B1',  3.5),
    (300, 900,    5,    20,  'yes', 'B2',  2.5),
    (300, 900,   -5,   -1,   'no',  'B1n', 1.1),
    (300, 900,  -20,   -5,   'no',  'B2n', 1.2),
]
