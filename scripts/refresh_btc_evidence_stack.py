...
def planned_steps(args: argparse.Namespace) -> list[Step]:
    steps = [
        ...
        Step(
            ...
            py(
                "scripts/build_btc1h_clean_evidence_clock_gate.py",
                "--out-dir",
        ...
        Step(
            ...
            py(
                "scripts/build_btc1h_replay_root_cause_audit.py",
                "--out-dir",
        ...
        Step(
            ...
            py(
                "scripts/build_btc1h_order_decision_replay_baseline.py",
                "--out-dir",
        ...
        Step(
            ...
            py(
                "scripts/build_btc1h_replay_vs_ledger_reconciliation.py",
                "--replay-trades",
                "backtest_outputs/btc1h_order_decision_replay_baseline_latest_codex/btc1h_order_decision_replay_trades.csv",
                "--replay-evidence-kind",
                "captured_order_decision_log",
                "--out-dir",
        ...
        Step(
            ...
            py(
                "scripts/build_btc1h_replay_repair_feasibility.py",
                "--out-dir",
        ...
        Step(
            ...
            py(
                "scripts/build_btc1h_replay_repair_target_matrix.py",
                "--out-dir",
        ...
        Step(
            ...
            py(
                "scripts/build_btc1h_replay_repair_prerequisite_audit.py",
                "--out-dir",
        ...
        Step(
            ...
            py(
                "scripts/build_btc1h_replay_repair_attempt_audit.py",
                "--out-dir",
        ...
        Step(
            ...
            py(
                "scripts/build_btc1h_faithful_replay_data_contract.py",
                "--out-dir",
        ...
        Step(
            ...
            py(
                "scripts/build_btc1h_replay_source_contract_readiness.py",
                "--out-dir",
        ...
        Step(
            ...
            py(
                "scripts/build_btc1h_clean_clock_collection_preflight.py",
                "--out-dir",
        ...
        Step(
            ...
            py(
                "scripts/build_btc1h_official_basis_mismatch_audit.py",
                "--out-dir",
        ...
        Step(
            ...
            py(
                "scripts/build_btc1h_basis_stress_audit.py",
                "--out-dir",
        ...
        Step(
            ...
            py(
                "scripts/build_btc1h_variant_basis_stress_ranking.py",
                "--out-dir",
        ...
        Step(
            ...
            py(
                "scripts/build_btc1h_decision_distance_guard_audit.py",
                "--out-dir",
        ...
        Step(
            ...
            py(
                "scripts/build_btc1h_side_entry_profile_audit.py",
                "--out-dir",
        ...
        Step(
            ...
            py(
                "scripts/build_btc1h_holdout_independence_audit.py",
                "--out-dir",
        ...
        Step(
            ...
            py(
                "scripts/build_btc1h_statistical_confidence_audit.py",
                "--out-dir",
        ...
        Step(
            ...
            py(
                "scripts/build_btc1h_replay_variant_overlap_audit.py",
                "--out-dir",
        ...
        Step(
            ...
            py(
                "scripts/build_btc1h_entry59_floor_filter_audit.py",
                "--out-dir",
        ...
        Step(
            ...
            py(
                "scripts/build_btc1h_no_chase_extra_row_audit.py",
                "--out-dir",
        ...
        Step(
            ...
            py(
                "scripts/build_btc1h_research_priority_matrix.py",
                "--out-dir",
        ...
        Step(
            ...
            py(
                "scripts/build_btc1h_next_forward_candidate_packet.py",
                "--out-dir",
        ...
        Step(
            ...
            py(
                "scripts/build_btc1h_promotion_gap_matrix.py",
                "--out-dir",
        ...
        Step(
            ...
            py(
                "scripts/build_btc1h_snapshot_execution_realism_audit.py",
                "--out-dir",
        ...
        Step(
            ...
            py(
                "scripts/build_btc1h_execution_filter_impact_audit.py",
                "--out-dir",
        ...
        Step(
            ...
            py(
                "scripts/build_btc1h_execution_filtered_basis_mismatch_audit.py",
                "--out-dir",
        ...
        Step(
            ...
            py(
                "scripts/build_btc1h_official_pnl_path_audit.py",
                "--out-dir",
        ...
        Step(
            ...
            py(
                "scripts/build_btc1h_objective_completion_audit.py",
                "--out-dir",
        ...
        Step(
            ...
            py(
                "scripts/build_btc1h_candidate_promotion_deficit_audit.py",
                "--out-dir",
                "backtest_outputs/btc1h_candidate_promotion_deficit_latest_codex",
            ),
        ),
        Step(
            "btc1h_remaining_evidence_manifest",
            py(
                "scripts/build_btc1h_remaining_evidence_manifest.py",
                "--out-dir",
